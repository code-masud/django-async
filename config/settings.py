...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-l^yeu)6*1b)@urkm!u+1l5lk(3rph!pbdmlqjr@c^ogvf*81&&')
...
CACHES = {
    "default": {
        "BACKEND": os.getenv('REDIS_BACKEND', "django_redis.cache.RedisCache"),
        "LOCATION": os.getenv('REDIS_LOCATION', 'redis://127.0.0.1:6379'),
        "OPTIONS": {
            "CLIENT_CLASS": os.getenv('REDIS_CLIENT_CLASS', "django_redis.client.DefaultClient"),
        }
    }
}
